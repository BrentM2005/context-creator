...
class HomeView(QWidget):
    ...
    def _build_ui(self):
        ...
        self.lbl_home_footer = QLabel()
        self.lbl_home_footer.setAlignment(Qt.AlignCenter)
        self.lbl_home_footer.setStyleSheet("color: #94A3B8; font-size: 13px; margin-top: 12px;")
        container_layout.addWidget(self.lbl_home_footer)
    ...
    def retranslate_ui(self):
        ...
        self.lbl_home_footer.setText(i18n.tr("home_footer"))